...
const organizationSchema={"@context":"https://schema.org","@type":"Organization",name:"올바른철거",legalName:"올바른",url:baseUrl,logo:`${baseUrl}/images/brand/logo.png`,telephone:"010-6648-4886",email:"chlpjy@naver.com",identifier:{"@type":"PropertyValue",propertyID:"사업자등록번호",value:"808-66-00808"},address:{"@type":"PostalAddress",streetAddress:"시랑로 132번길 17-4 504",addressLocality:"북구",addressRegion:"부산광역시",addressCountry:"KR"},contactPoint:{"@type":"ContactPoint",contactType:"customer service",telephone:"010-6648-4886",email:"chlpjy@naver.com",areaServed:"KR",availableLanguage:"Korean"},areaServed:{"@type":"AdministrativeArea",name:"부산광역시"},knowsAbout:["철거","원상복구","상가철거","폐업철거","점포철거"]};
...
export default function RootLayout({children}:{children:React.ReactNode}){
 return <html lang="ko"><body>
  ...
  <footer className="site-footer">
   ...
   <div><a className="footer-brand" href="/" aria-label="올바른철거 홈"><img className="footer-logo" src="/images/brand/logo.png" alt="올바른철거"/></a><p>부산 철거 · 원상복구 · 폐업지원 안내</p><p>Tel. <a href="tel:01066484886">010-6648-4886</a> · Fax. 0508-956-6109 · <a href="mailto:chlpjy@naver.com">chlpjy@naver.com</a></p><p>부산광역시 북구 시랑로 132번길 17-4 504 · 상호: 올바른 · 업태: 건선업 · 업종: 철거 · 사업자등록번호: 808-66-00808</p><p>업무 제휴 문의 <a href="mailto:chlpjy@naver.com">chlpjy@naver.com</a></p><p><a href="/company">회사정보</a> · <a href="/privacy">개인정보처리 안내</a></p></div>
